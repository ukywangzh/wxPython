# http://article.gmane.org/gmane.comp.python.wxpython/34833/match=calculator
'''wxPython Calculator Demo in 50 lines of code'''

# Author: Miki Tebeka <miki.tebeka <at> gmail.com>
# License: BSD
# $Id: calc.py 773 2006-05-23 08:02:24Z mtebeka $
...
class Calculator(wx.Dialog):
    ...
    def OnButton(self, evt):
        ...
        label = evt.GetEventObject().GetLabel() ######## Here is the only place that was changed.
